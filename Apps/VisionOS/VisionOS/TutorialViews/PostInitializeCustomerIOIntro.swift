...
Other campaigns might want to only target user with specific
...
or tap a button.
- Add/Set device attributes. Other campaigns might want to only target
...
impact running campaigns that use these names on **Customer.io**.
