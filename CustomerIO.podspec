...
Pod::Spec.new do |spec|
  ...
  spec.version      = "4.7.1" # Don't modify this line - it's automatically updated
  ...
  spec.subspec "MessagingInbox" do |ss|
    ss.dependency "CustomerIOMessagingInbox", "= #{spec.version.to_s}"
  end
