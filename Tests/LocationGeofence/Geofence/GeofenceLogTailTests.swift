...
struct GeofenceLogTailTests {
    ...
    private var invocations: [Invocation] {
        ...
        return [
            ...
            Invocation(name: "conditionAdded", ev: "registration.added", requiredKeys: ["id"]) { $0.geofenceConditionAdded(identifier: "notl_core") },
            Invocation(name: "conditionRemovedForReadd", ev: "registration.removed", requiredKeys: ["id", "op"]) { $0.geofenceConditionRemoved(identifier: "notl_core", op: .readd) },
            Invocation(name: "conditionRemovedForDrop", ev: "registration.removed", requiredKeys: ["id", "op"]) { $0.geofenceConditionRemoved(identifier: "notl_core", op: .drop) },
