...
public class MessagingInAppInstanceMock: MessagingInAppInstance, Mock {
    ...
    public func resetMock() {
        ...
        setInboxEventListenerReceivedArguments = nil
        setInboxEventListenerReceivedInvocations = []
    ...
    /// Number of times the function was called.
    @Atomic public private(set) var setInboxEventListenerCallsCount = 0
    /// `true` if the function was ever called.
    ...
    /// The arguments from the *last* time the function was called.
    @Atomic public private(set) var setInboxEventListenerReceivedArguments: InboxEventListener??
    /// Arguments from *all* of the times that the function was called.
    @Atomic public private(set) var setInboxEventListenerReceivedInvocations: [InboxEventListener?] = []
    /**
     Set closure to get called when function gets called. Great way to test logic or return a value for the function.
     */
    ...
    public func setInboxEventListener(_ inboxEventListener: InboxEventListener?) {
        mockCalled = true
        setInboxEventListenerCallsCount += 1
        setInboxEventListenerReceivedArguments = inboxEventListener
        setInboxEventListenerReceivedInvocations.append(inboxEventListener)
