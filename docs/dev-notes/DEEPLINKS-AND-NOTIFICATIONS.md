...
**Notes:**
- Native hosts register `deepLinkCallback` through the public `SDKConfigBuilder.deepLinkCallback(_:)` API. React Native and Flutter wrappers install their own native routing adapters.
