# ADR 003 — Swift 6.2 Actor-Based Concurrency Throughout
...
`cdp-analytics-swift` (removed per ADR 001) produced `@preconcurrency` wrappers
or suppressed warnings that hid real data races. A clean Swift 6.2 codebase is
structurally incompatible with its concurrency model.
