...
```swift
// Configure the SDK with the builder pattern
...
- **Auto-Generated Mocks**: 
  ...
  - Generated into `Tests/Mocks/<Module>` as `AutoMockable.generated.swift` (only `AutoDependencyInjection.generated.swift` is generated into `Sources/<Module>/autogenerated`)
