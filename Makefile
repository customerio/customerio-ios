...
generate:
	$(RUN_TOOL_CMD) sourcery --sources Sources/Common --templates Sources/Templates --output Sources/Common/autogenerated 
	$(RUN_TOOL_CMD) sourcery --sources Sources/Tracking --templates Sources/Templates --output Sources/Tracking/autogenerated --args imports=CioInternalCommon
	$(RUN_TOOL_CMD) sourcery --sources Sources/MessagingPush --templates Sources/Templates --output Sources/MessagingPush/autogenerated --args imports=CioTracking-CioInternalCommon
	$(RUN_TOOL_CMD) sourcery --sources Sources/MessagingPushAPN --templates Sources/Templates --output Sources/MessagingPushAPN/autogenerated --args imports=CioMessagingPush-CioTracking-CioInternalCommon
	$(RUN_TOOL_CMD) sourcery --sources Sources/MessagingPushFCM --templates Sources/Templates --output Sources/MessagingPushFCM/autogenerated --args imports=CioMessagingPush-CioTracking-CioInternalCommon
	$(RUN_TOOL_CMD) sourcery --sources Sources/MessagingInApp --templates Sources/Templates --output Sources/MessagingInApp/autogenerated --args imports=CioTracking-CioInternalCommon

lint:
	$(RUN_TOOL_CMD) swiftlint lint --strict
...
format:
	$(RUN_TOOL_CMD) swiftformat . --swiftversion 5.3 && $(RUN_TOOL_CMD) swiftlint lint --fix
