...
generate:
	...
	sourcery --sources Sources/MessagingPush --templates Sources/Templates --output Sources/MessagingPush/autogenerated --args diAccessLevel=public,moduleName=MessagingPush,imports=CioTracking:Common
	sourcery --sources Sources/MessagingPushAPN --templates Sources/Templates --output Sources/MessagingPushAPN/autogenerated --args diAccessLevel=internal,moduleName=MessagingPushAPN,imports=CioMessagingPush:CioTracking:Common
	sourcery --sources Sources/MessagingPushFCM --templates Sources/Templates --output Sources/MessagingPushFCM/autogenerated --args diAccessLevel=internal,moduleName=MessagingPushFCM,imports=CioMessagingPush:CioTracking:Common
	sourcery --sources Sources/MessagingInApp --templates Sources/Templates --output Sources/MessagingInApp/autogenerated --args diAccessLevel=internal,moduleName=MessagingInApp,imports=CioTracking:Common:Gist 
