...
/**
 Class to easily create a mocked version of the `DateUtil` class.
 This class is equipped with functions and properties ready for you to mock!

 Note: This file is automatically generated. This means the mocks should always be up-to-date and has a consistent API.
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class DateUtilMock: DateUtil, TrackingMock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
    ...
    /// `true` if the getter or setter of property is called at least once.
    public var nowCalled: Bool {
        nowGetCalled || nowSetCalled
    }

    /// `true` if the getter called on the property at least once.
    public var nowGetCalled: Bool {
        nowGetCallsCount > 0
    }

    public var nowGetCallsCount = 0
    /// `true` if the setter called on the property at least once.
    public var nowSetCalled: Bool {
        nowSetCallsCount > 0
    }

    public var nowSetCallsCount = 0
    /// The mocked property with a getter and setter.
    public var now: Date {
        get {
            mockCalled = true
            nowGetCallsCount += 1
            return underlyingNow
        }
        set(value) {
            mockCalled = true
            nowSetCallsCount += 1
...
public class DeviceInfoMock: DeviceInfo, TrackingMock {
    ...
    /**
     ...
     When the getter of the property called, the value set here will be returned. Your chance to mock the property.
     */
    public var underlyingOsInfo: String?
    /// `true` if the getter or setter of property is called at least once.
    public var osInfoCalled: Bool {
        osInfoGetCalled || osInfoSetCalled
    }

    /// `true` if the getter called on the property at least once.
    public var osInfoGetCalled: Bool {
        osInfoGetCallsCount > 0
    }

    public var osInfoGetCallsCount = 0
    /// `true` if the setter called on the property at least once.
    public var osInfoSetCalled: Bool {
        osInfoSetCallsCount > 0
    }

    public var osInfoSetCallsCount = 0
    /// The mocked property with a getter and setter.
    public var osInfo: String? {
        get {
            mockCalled = true
            osInfoGetCallsCount += 1
            return underlyingOsInfo
        }
        set(value) {
            mockCalled = true
            osInfoSetCallsCount += 1
            underlyingOsInfo = value
        }
    }
