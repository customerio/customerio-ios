...
internal class HttpRequestRunnerMock: HttpRequestRunner {
    ...
    /// The arguments from the *last* time the function was called. 
    internal var requestReceivedArguments: (params: HttpRequestParams, httpBaseUrls: HttpBaseUrls, onComplete: (Data?, HTTPURLResponse?, Error?) -> Void)?
    /// Arguments from *all* of the times that the function was called. 
    internal var requestReceivedInvocations: [(params: HttpRequestParams, httpBaseUrls: HttpBaseUrls, onComplete: (Data?, HTTPURLResponse?, Error?) -> Void)] = []
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    internal var requestClosure: ((HttpRequestParams, HttpBaseUrls, @escaping (Data?, HTTPURLResponse?, Error?) -> Void) -> Void)?
...
internal class IdentifyRepositoryMock: IdentifyRepository {
    ...
    /// Number of times the function was called.  
    internal var setIdentifierCallsCount = 0
    /// `true` if the function was ever called. 
    internal var setIdentifierCalled: Bool {
        return setIdentifierCallsCount > 0
    }
    /// The arguments from the *last* time the function was called. 
    internal var setIdentifierReceivedArguments: (String)?
    /// Arguments from *all* of the times that the function was called. 
    internal var setIdentifierReceivedInvocations: [(String)] = []
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    internal var setIdentifierClosure: ((String) -> Void)?

    /// Mocked function for `setIdentifier(identifier: String)`. Your opportunity to return a mocked value and check result of mock in test code. 
    internal func setIdentifier(identifier: String) {
        self.mockCalled = true
        setIdentifierCallsCount += 1
        setIdentifierReceivedArguments = (identifier)
        setIdentifierReceivedInvocations.append((identifier))
        setIdentifierClosure?(identifier)
    }
    ...
    /// The arguments from the *last* time the function was called. 
    internal var addOrUpdateCustomerReceivedArguments: (identifier: String, email: String?, onComplete: (Result<Void, CustomerIOError>) -> Void)?
    /// Arguments from *all* of the times that the function was called. 
    internal var addOrUpdateCustomerReceivedInvocations: [(identifier: String, email: String?, onComplete: (Result<Void, CustomerIOError>) -> Void)] = []
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    internal var addOrUpdateCustomerClosure: ((String, String?, @escaping (Result<Void, CustomerIOError>) -> Void) -> Void)?
    ...
    internal func addOrUpdateCustomer(identifier: String, email: String?, onComplete: @escaping (Result<Void, CustomerIOError>) -> Void) {
        self.mockCalled = true
