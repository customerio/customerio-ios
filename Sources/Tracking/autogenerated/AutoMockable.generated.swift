...
public class CustomerIOInstanceMock: CustomerIOInstance, Mock {
    ...
    // MARK: - showPromptForPushNotifications

    /// Number of times the function was called.  
    public private(set) var showPromptForPushNotificationsCallsCount = 0
    /// `true` if the function was ever called. 
    public var showPromptForPushNotificationsCalled: Bool {
        return showPromptForPushNotificationsCallsCount > 0
    }    
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    public var showPromptForPushNotificationsClosure: (() -> Void)?

    /// Mocked function for `showPromptForPushNotifications()`. Your opportunity to return a mocked value and check result of mock in test code.
