...
public class CustomerIOInstanceMock: CustomerIOInstance {
    ...
    public var identifyBodyCalled: Bool {
        return identifyBodyCallsCount > 0
    }
    /// The arguments from the *last* time the function was called. 
    public private(set) var identifyBodyReceivedArguments: (identifier: String, body: AnyEncodable, onComplete: (Result<Void, CustomerIOError>) -> Void, jsonEncoder: JSONEncoder?)?
    /// Arguments from *all* of the times that the function was called. 
    public private(set) var identifyBodyReceivedInvocations: [(identifier: String, body: AnyEncodable, onComplete: (Result<Void, CustomerIOError>) -> Void, jsonEncoder: JSONEncoder?)] = []
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    public var identifyBodyClosure: ((String, AnyEncodable, (Result<Void, CustomerIOError>) -> Void, JSONEncoder?) -> Void)?
    ...
    public func identify<RequestBody: Encodable>(identifier: String, body: RequestBody, onComplete: @escaping (Result<Void, CustomerIOError>) -> Void, jsonEncoder: JSONEncoder?) {
        ...
        identifyBodyReceivedArguments = (identifier: identifier, body: AnyEncodable(body), onComplete: onComplete, jsonEncoder: jsonEncoder)
        identifyBodyReceivedInvocations.append((identifier: identifier, body: AnyEncodable(body), onComplete: onComplete, jsonEncoder: jsonEncoder))
    ...
    public var identifyStopCalled: Bool {
        return identifyStopCallsCount > 0
    }
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
