...
/**
 Class to easily create a mocked version of the `DeepLinkDelegate` class.
 This class is equipped with functions and properties ready for you to mock!

 Note: This file is automatically generated. This means the mocks should always be up-to-date and has a consistent API.
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class DeepLinkDelegateMock: DeepLinkDelegate, Mock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
    ...
    public func resetMock() {
        onOpenDeepLinkCallsCount = 0
        onOpenDeepLinkReceivedArguments = nil
        onOpenDeepLinkReceivedInvocations = []
    ...
    /// Number of times the function was called.
    public private(set) var onOpenDeepLinkCallsCount = 0
    /// `true` if the function was ever called.
    public var onOpenDeepLinkCalled: Bool {
        onOpenDeepLinkCallsCount > 0
    }

    /// The arguments from the *last* time the function was called.
    public private(set) var onOpenDeepLinkReceivedArguments: DeepLink?
    /// Arguments from *all* of the times that the function was called.
    public private(set) var onOpenDeepLinkReceivedInvocations: [DeepLink] = []
    /// Value to return from the mocked function.
    public var onOpenDeepLinkReturnValue: Bool!
    /**
     Set closure to get called when function gets called. Great way to test logic or return a value for the function.
     The closure has first priority to return a value for the mocked function. If the closure returns `nil`,
     then the mock will attempt to return the value for `onOpenDeepLinkReturnValue`
     */
    public var onOpenDeepLinkClosure: ((DeepLink) -> Bool)?

    /// Mocked function for `onOpenDeepLink(deepLink: DeepLink)`. Your opportunity to return a mocked value and check result of mock in test code.
    public func onOpenDeepLink(deepLink: DeepLink) -> Bool {
        mockCalled = true
        onOpenDeepLinkCallsCount += 1
        onOpenDeepLinkReceivedArguments = deepLink
        onOpenDeepLinkReceivedInvocations.append(deepLink)
        return onOpenDeepLinkClosure.map { $0(deepLink) } ?? onOpenDeepLinkReturnValue
    }
}
