...
/**
 Class to easily create a mocked version of the `InlineMessageDelegate` class.
 This class is equipped with functions and properties ready for you to mock!

 Note: This file is automatically generated. This means the mocks should always be up-to-date and has a consistent API.
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class InlineMessageDelegateMock: InlineMessageDelegate, Mock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
    ...
    public func resetMock() {
        onInlineCustomButtonActionCallsCount = 0
        onInlineCustomButtonActionReceivedArguments = nil
        onInlineCustomButtonActionReceivedInvocations = []

        mockCalled = false // do last as resetting properties above can make this true
    }

    // MARK: - onInlineCustomButtonAction

    /// Number of times the function was called.
    @Atomic public private(set) var onInlineCustomButtonActionCallsCount = 0
    /// `true` if the function was ever called.
    public var onInlineCustomButtonActionCalled: Bool {
        onInlineCustomButtonActionCallsCount > 0
    }

    /// The arguments from the *last* time the function was called.
    @Atomic public private(set) var onInlineCustomButtonActionReceivedArguments: (message: Message, action: String, name: String)?
    /// Arguments from *all* of the times that the function was called.
    @Atomic public private(set) var onInlineCustomButtonActionReceivedInvocations: [(message: Message, action: String, name: String)] = []
    /**
     Set closure to get called when function gets called. Great way to test logic or return a value for the function.
     */
    public var onInlineCustomButtonActionClosure: ((Message, String, String) -> Void)?

    /// Mocked function for `onInlineCustomButtonAction(message: Message, action: String, name: String)`. Your opportunity to return a mocked value and check result of mock in test code.
    public func onInlineCustomButtonAction(message: Message, action: String, name: String) {
        mockCalled = true
        onInlineCustomButtonActionCallsCount += 1
        onInlineCustomButtonActionReceivedArguments = (message: message, action: action, name: name)
        onInlineCustomButtonActionReceivedInvocations.append((message: message, action: action, name: name))
        onInlineCustomButtonActionClosure?(message, action, name)
    }
}
