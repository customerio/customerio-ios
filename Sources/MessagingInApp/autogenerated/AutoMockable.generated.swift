...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
class ApplicationStateProviderMock: ApplicationStateProvider, Mock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    var mockCalled: Bool = false //
...
/**
 Class to easily create a mocked version of the `MessageInboxInstance` class.
 This class is equipped with functions and properties ready for you to mock!

 Note: This file is automatically generated. This means the mocks should always be up-to-date and has a consistent API.
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class MessageInboxInstanceMock: MessageInboxInstance, Mock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
    ...
    public func resetMock() {
        ...
        addChangeListenerReceivedArguments = nil
        addChangeListenerReceivedInvocations = []

        mockCalled = false // do last as resetting properties above can make this true
        removeChangeListenerCallsCount = 0
        removeChangeListenerReceivedArguments = nil
        removeChangeListenerReceivedInvocations = []

        mockCalled = false // do last as resetting properties above can make this true
        markMessageOpenedCallsCount = 0
        markMessageOpenedReceivedArguments = nil
        markMessageOpenedReceivedInvocations = []

        mockCalled = false // do last as resetting properties above can make this true
        markMessageUnopenedCallsCount = 0
        markMessageUnopenedReceivedArguments = nil
        markMessageUnopenedReceivedInvocations = []

        mockCalled = false // do last as resetting properties above can make this true
        markMessageDeletedCallsCount = 0
        markMessageDeletedReceivedArguments = nil
        markMessageDeletedReceivedInvocations = []

        mockCalled = false // do last as resetting properties above can make this true
        trackMessageClickedCallsCount = 0
        trackMessageClickedReceivedArguments = nil
        trackMessageClickedReceivedInvocations = []
    ...
    /// Number of times the function was called.
    @Atomic public private(set) var getMessagesCallsCount = 0
    /// `true` if the function was ever called.
    public var getMessagesCalled: Bool {
        getMessagesCallsCount > 0
    }
    ...
    /// Number of times the function was called.
    @Atomic public private(set) var addChangeListenerCallsCount = 0
    /// `true` if the function was ever called.
    public var addChangeListenerCalled: Bool {
        addChangeListenerCallsCount > 0
    }

    /// The arguments from the *last* time the function was called.
    @Atomic public private(set) var addChangeListenerReceivedArguments: InboxMessageChangeListener?
    /// Arguments from *all* of the times that the function was called.
    @Atomic public private(set) var addChangeListenerReceivedInvocations: [InboxMessageChangeListener] = []
    /**
     Set closure to get called when function gets called. Great way to test logic or return a value for the function.
     */
    public var addChangeListenerClosure: ((InboxMessageChangeListener) -> Void)?

    /// Mocked function for `addChangeListener(_ listener: InboxMessageChangeListener)`. Your opportunity to return a mocked value and check result of mock in test code.
    public func addChangeListener(_ listener: InboxMessageChangeListener) {
        mockCalled = true
        addChangeListenerCallsCount += 1
        addChangeListenerReceivedArguments = listener
        addChangeListenerReceivedInvocations.append(listener)
        addChangeListenerClosure?(listener)
    }

    // MARK: - removeChangeListener

    /// Number of times the function was called.
    @Atomic public private(set) var removeChangeListenerCallsCount = 0
    /// `true` if the function was ever called.
    public var removeChangeListenerCalled: Bool {
        removeChangeListenerCallsCount > 0
    }

    /// The arguments from the *last* time the function was called.
    @Atomic public private(set) var removeChangeListenerReceivedArguments: InboxMessageChangeListener?
    /// Arguments from *all* of the times that the function was called.
    @Atomic public private(set) var removeChangeListenerReceivedInvocations: [InboxMessageChangeListener] = []
    /**
     Set closure to get called when function gets called. Great way to test logic or return a value for the function.
     */
    public var removeChangeListenerClosure: ((InboxMessageChangeListener) -> Void)?

    /// Mocked function for `removeChangeListener(_ listener: InboxMessageChangeListener)`. Your opportunity to return a mocked value and check result of mock in test code.
    public func removeChangeListener(_ listener: InboxMessageChangeListener) {
        mockCalled = true
        removeChangeListenerCallsCount += 1
        removeChangeListenerReceivedArguments = listener
        removeChangeListenerReceivedInvocations.append(listener)
        removeChangeListenerClosure?(listener)
    }

    // MARK: - markMessageOpened

    /// Number of times the function was called.
    @Atomic public private(set) var markMessageOpenedCallsCount = 0
    /// `true` if the function was ever called.
    public var markMessageOpenedCalled: Bool {
        markMessageOpenedCallsCount > 0
    }

    /// The arguments from the *last* time the function was called.
    @Atomic public private(set) var markMessageOpenedReceivedArguments: InboxMessage?
    /// Arguments from *all* of the times that the function was called.
    @Atomic public private(set) var markMessageOpenedReceivedInvocations: [InboxMessage] = []
    /**
     Set closure to get called when function gets called. Great way to test logic or return a value for the function.
     */
    public var markMessageOpenedClosure: ((InboxMessage) -> Void)?

    /// Mocked function for `markMessageOpened(message: InboxMessage)`. Your opportunity to return a mocked value and check result of mock in test code.
    public func markMessageOpened(message: InboxMessage) {
        mockCalled = true
        markMessageOpenedCallsCount += 1
        markMessageOpenedReceivedArguments = message
        markMessageOpenedReceivedInvocations.append(message)
        markMessageOpenedClosure?(message)
    }

    // MARK: - markMessageUnopened

    /// Number of times the function was called.
    @Atomic public private(set) var markMessageUnopenedCallsCount = 0
    /// `true` if the function was ever called.
    public var markMessageUnopenedCalled: Bool {
        markMessageUnopenedCallsCount > 0
    }

    /// The arguments from the *last* time the function was called.
    @Atomic public private(set) var markMessageUnopenedReceivedArguments: InboxMessage?
    /// Arguments from *all* of the times that the function was called.
    @Atomic public private(set) var markMessageUnopenedReceivedInvocations: [InboxMessage] = []
    /**
     Set closure to get called when function gets called. Great way to test logic or return a value for the function.
     */
    public var markMessageUnopenedClosure: ((InboxMessage) -> Void)?

    /// Mocked function for `markMessageUnopened(message: InboxMessage)`. Your opportunity to return a mocked value and check result of mock in test code.
    public func markMessageUnopened(message: InboxMessage) {
        mockCalled = true
        markMessageUnopenedCallsCount += 1
        markMessageUnopenedReceivedArguments = message
        markMessageUnopenedReceivedInvocations.append(message)
        markMessageUnopenedClosure?(message)
    }

    // MARK: - markMessageDeleted

    /// Number of times the function was called.
    @Atomic public private(set) var markMessageDeletedCallsCount = 0
    /// `true` if the function was ever called.
    public var markMessageDeletedCalled: Bool {
        markMessageDeletedCallsCount > 0
    }

    /// The arguments from the *last* time the function was called.
    @Atomic public private(set) var markMessageDeletedReceivedArguments: InboxMessage?
    /// Arguments from *all* of the times that the function was called.
    @Atomic public private(set) var markMessageDeletedReceivedInvocations: [InboxMessage] = []
    /**
     Set closure to get called when function gets called. Great way to test logic or return a value for the function.
     */
    public var markMessageDeletedClosure: ((InboxMessage) -> Void)?

    /// Mocked function for `markMessageDeleted(message: InboxMessage)`. Your opportunity to return a mocked value and check result of mock in test code.
    public func markMessageDeleted(message: InboxMessage) {
        mockCalled = true
        markMessageDeletedCallsCount += 1
        markMessageDeletedReceivedArguments = message
        markMessageDeletedReceivedInvocations.append(message)
        markMessageDeletedClosure?(message)
    }

    // MARK: - trackMessageClicked

    /// Number of times the function was called.
    @Atomic public private(set) var trackMessageClickedCallsCount = 0
    /// `true` if the function was ever called.
    public var trackMessageClickedCalled: Bool {
        trackMessageClickedCallsCount > 0
    }

    /// The arguments from the *last* time the function was called.
    @Atomic public private(set) var trackMessageClickedReceivedArguments: (message: InboxMessage, actionName: String?)?
    /// Arguments from *all* of the times that the function was called.
    @Atomic public private(set) var trackMessageClickedReceivedInvocations: [(message: InboxMessage, actionName: String?)] = []
    /**
     Set closure to get called when function gets called. Great way to test logic or return a value for the function.
     */
    public var trackMessageClickedClosure: ((InboxMessage, String?) -> Void)?

    /// Mocked function for `trackMessageClicked(message: InboxMessage, actionName: String?)`. Your opportunity to return a mocked value and check result of mock in test code.
    public func trackMessageClicked(message: InboxMessage, actionName: String?) {
        mockCalled = true
        trackMessageClickedCallsCount += 1
        trackMessageClickedReceivedArguments = (message: message, actionName: actionName)
        trackMessageClickedReceivedInvocations.append((message: message, actionName: actionName))
        trackMessageClickedClosure?(message, actionName)
    }
}
