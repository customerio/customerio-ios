...
/**
 Class to easily create a mocked version of the `FileDownloadHttpClient` class.
 This class is equipped with functions and properties ready for you to mock!

 Note: This file is automatically generated. This means the mocks should always be up-to-date and has a consistent API.
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class FileDownloadHttpClientMock: FileDownloadHttpClient, Mock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
...
internal class HttpRequestRunnerMock: HttpRequestRunner, Mock {
    ...
    internal private(set) var downloadFileReceivedArguments: (
        ...
        fileType: DownloadFileType,
        session: URLSession,
        onComplete: (URL?, HTTPURLResponse?, Error?) -> Void
    )?
    /// Arguments from *all* of the times that the function was called.
    ...
    /**
     Set closure to get called when function gets called. Great way to test logic or return a value for the function.
     */
    internal var downloadFileClosure: (
        (URL, DownloadFileType, URLSession, (URL?, HTTPURLResponse?, Error?) -> Void)
            -> Void
    )?

    /// Mocked function for `downloadFile(url: URL, fileType: DownloadFileType, session: URLSession, onComplete:
    /// @escaping (URL?, HTTPURLResponse?, Error?) -> Void)`. Your opportunity to return a mocked value and check result
