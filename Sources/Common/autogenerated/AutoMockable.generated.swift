 ...
 */
public class BackgroundDeliveryHttpClientMock: BackgroundDeliveryHttpClient, Mock {
    ...
    public func resetMock() {
        ...
        sendTrackEventReceivedArguments = nil
        sendTrackEventReceivedInvocations = []
    ...
    @Atomic public private(set) var sendTrackEventCallsCount = 0
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class PendingPushDeliveryStoreMock: PendingPushDeliveryStore, Mock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
    ...
    public var appGroupSuiteNameGetCallsCount = 0
    /// `true` if the setter called on the property at least once.
    ...
    public var appGroupSuiteName: String? {
        ...
        set(value) {
            mockCalled = true
            appGroupSuiteNameSetCallsCount += 1
    ...
    public func resetMock() {
        ...
        appGroupSuiteNameSetCallsCount = 0
        appendCallsCount = 0
        appendReceivedArguments = nil
        appendReceivedInvocations = []
    ...
    /// Number of times the function was called.
    @Atomic public private(set) var appendCallsCount = 0
    /// `true` if the function was ever called.
    ...
    /// The arguments from the *last* time the function was called.
    @Atomic public private(set) var appendReceivedArguments: PendingPushDeliveryMetric?
    /// Arguments from *all* of the times that the function was called.
    @Atomic public private(set) var appendReceivedInvocations: [PendingPushDeliveryMetric] = []
    /// Value to return from the mocked function.
    ...
    public func append(_ metric: PendingPushDeliveryMetric) -> Bool {
        mockCalled = true
        appendCallsCount += 1
        appendReceivedArguments = metric
        appendReceivedInvocations.append(metric)
    ...
    /// Number of times the function was called.
    @Atomic public private(set) var loadAllCallsCount = 0
    /// `true` if the function was ever called.
    ...
    /// The arguments from the *last* time the function was called.
    @Atomic public private(set) var removeReceivedArguments: UUID?
    /// Arguments from *all* of the times that the function was called.
    @Atomic public private(set) var removeReceivedInvocations: [UUID] = []
    /// Value to return from the mocked function.
