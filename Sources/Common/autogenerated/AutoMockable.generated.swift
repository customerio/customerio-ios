...
public class CustomerIOInstanceMock: CustomerIOInstance, Mock {
    ...
    public var setProfileAttributesCalled: Bool {
        return setProfileAttributesCallsCount > 0
    }    
    ...
    public var setDeviceAttributesCalled: Bool {
        return setDeviceAttributesCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK. 
 */
public class DeepLinkUtilMock: DeepLinkUtil, Mock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called. 
    public var mockCalled: Bool = false // 
    ...
    public var setDeepLinkCallbackCalled: Bool {
        return setDeepLinkCallbackCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
    ...
    /// Number of times the function was called.  
    @Atomic public private(set) var handleDeepLinkCallsCount = 0
    /// `true` if the function was ever called. 
    public var handleDeepLinkCalled: Bool {
        return handleDeepLinkCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
    @Atomic public private(set) var handleDeepLinkReceivedArguments: (URL)?
    /// Arguments from *all* of the times that the function was called. 
    @Atomic public private(set) var handleDeepLinkReceivedInvocations: [(URL)] = []
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
...
public class EventCacheMock: EventCache, Mock {
    ...
    public var storeEventsCalled: Bool {
        return storeEventsCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
    ...
    public var removeAllEventsForKeyCalled: Bool {
        return removeAllEventsForKeyCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
...
public class HttpClientMock: HttpClient, Mock {
    ...
    /// The arguments from the *last* time the function was called. 
    @Atomic public private(set) var requestReceivedArguments: (CioInternalCommon.HttpRequestParams)?
    /// Arguments from *all* of the times that the function was called. 
    @Atomic public private(set) var requestReceivedInvocations: [(CioInternalCommon.HttpRequestParams)] = []
    /// Value to return from the mocked function. 
    public var requestReturnValue: Result<Data, CioInternalCommon.HttpRequestError>!
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     The closure has first priority to return a value for the mocked function. If the closure returns `nil`, 
     then the mock will attempt to return the value for `requestReturnValue`
     */
    public var requestClosure: ((CioInternalCommon.HttpRequestParams) -> Result<Data, CioInternalCommon.HttpRequestError>)?

    /// Mocked function for `request(_ params: CioInternalCommon.HttpRequestParams)`. Your opportunity to return a mocked value and check result of mock in test code.
    public func request(_ params: CioInternalCommon.HttpRequestParams) -> Result<Data, CioInternalCommon.HttpRequestError> {
        self.mockCalled = true
        requestCallsCount += 1
        requestReceivedArguments = (params)
        requestReceivedInvocations.append((params))
        return requestClosure.map({ $0(params) }) ?? requestReturnValue
    }
    ...
    /// The arguments from the *last* time the function was called. 
    @Atomic public private(set) var downloadFileReceivedArguments: (url: URL, fileType: DownloadFileType)?
    /// Arguments from *all* of the times that the function was called. 
    @Atomic public private(set) var downloadFileReceivedInvocations: [(url: URL, fileType: DownloadFileType)] = []
    /// Value to return from the mocked function. 
    public var downloadFileReturnValue: URL?
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     The closure has first priority to return a value for the mocked function. If the closure returns `nil`, 
     then the mock will attempt to return the value for `downloadFileReturnValue`
     */
    public var downloadFileClosure: ((URL, DownloadFileType) -> URL?)?

    /// Mocked function for `downloadFile(url: URL, fileType: DownloadFileType)`. Your opportunity to return a mocked value and check result of mock in test code.
    public func downloadFile(url: URL, fileType: DownloadFileType) -> URL? {
        self.mockCalled = true
        downloadFileCallsCount += 1
        downloadFileReceivedArguments = (url: url, fileType: fileType)
        downloadFileReceivedInvocations.append((url: url, fileType: fileType))
        return downloadFileClosure.map({ $0(url, fileType) }) ?? downloadFileReturnValue
    }
...
public class HttpRequestRunnerMock: HttpRequestRunner, Mock {
    ...
    /// The arguments from the *last* time the function was called. 
    @Atomic public private(set) var requestReceivedArguments: (params: HttpRequestParams, session: URLSession)?
    /// Arguments from *all* of the times that the function was called. 
    @Atomic public private(set) var requestReceivedInvocations: [(params: HttpRequestParams, session: URLSession)] = []
    /// Value to return from the mocked function. 
    public var requestReturnValue: (Data, URLResponse)!
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     The closure has first priority to return a value for the mocked function. If the closure returns `nil`, 
     then the mock will attempt to return the value for `requestReturnValue`
     */
    public var requestClosure: ((HttpRequestParams, URLSession) throws -> (Data, URLResponse))?

    /// Mocked function for `request(params: HttpRequestParams, session: URLSession)`. Your opportunity to return a mocked value and check result of mock in test code.
    public func request(params: HttpRequestParams, session: URLSession) throws -> (Data, URLResponse) {
        if let error = requestThrowableError {
            throw error
        }
        self.mockCalled = true
        requestCallsCount += 1
        requestReceivedArguments = (params: params, session: session)
        requestReceivedInvocations.append((params: params, session: session))
        return try requestClosure.map({ try $0(params, session) }) ?? requestReturnValue
    }
    ...
    /// The arguments from the *last* time the function was called. 
    @Atomic public private(set) var downloadFileReceivedArguments: (url: URL, fileType: DownloadFileType, session: URLSession)?
    /// Arguments from *all* of the times that the function was called. 
    @Atomic public private(set) var downloadFileReceivedInvocations: [(url: URL, fileType: DownloadFileType, session: URLSession)] = []
    /// Value to return from the mocked function. 
    public var downloadFileReturnValue: URL?
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     ...
     then the mock will attempt to return the value for `downloadFileReturnValue`
     */
    public var downloadFileClosure: ((URL, DownloadFileType, URLSession) -> URL?)?

    /// Mocked function for `downloadFile(url: URL, fileType: DownloadFileType, session: URLSession)`. Your opportunity to return a mocked value and check result of mock in test code.
    public func downloadFile(url: URL, fileType: DownloadFileType, session: URLSession) -> URL? {
        self.mockCalled = true
        downloadFileCallsCount += 1
        downloadFileReceivedArguments = (url: url, fileType: fileType, session: session)
        downloadFileReceivedInvocations.append((url: url, fileType: fileType, session: session))
        return downloadFileClosure.map({ $0(url, fileType, session) }) ?? downloadFileReturnValue
    }
...
public class LoggerMock: Logger, Mock {
    ...
    public var setLogDispatcherCalled: Bool {
        return setLogDispatcherCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
    ...
    public var setLogLevelCalled: Bool {
        return setLogLevelCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
...
public class ProfileStoreMock: ProfileStore, Mock {
    ...
    public var getProfileIdCalled: Bool {
        return getProfileIdCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
    ...
    public var deleteProfileIdCalled: Bool {
        return deleteProfileIdCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
...
public class QueueMock: Queue, Mock {
    ...
    public var getAllStoredTasksCalled: Bool {
        return getAllStoredTasksCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
    ...
    public var getTaskDetailCalled: Bool {
        return getTaskDetailCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
    ...
    public var deleteProcessedTaskCalled: Bool {
        return deleteProcessedTaskCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK. 
 */
public class SdkCommonLoggerMock: SdkCommonLogger, Mock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called. 
    public var mockCalled: Bool = false // 
    ...
    public func resetMock() {
        ...
        moduleInitStartReceivedArguments = nil 
        moduleInitStartReceivedInvocations = []

        self.mockCalled = false // do last as resetting properties above can make this true
        moduleInitSuccessCallsCount = 0
        moduleInitSuccessReceivedArguments = nil 
        moduleInitSuccessReceivedInvocations = []

        self.mockCalled = false // do last as resetting properties above can make this true
        logHandlingNotificationDeepLinkCallsCount = 0
        logHandlingNotificationDeepLinkReceivedArguments = nil 
        logHandlingNotificationDeepLinkReceivedInvocations = []
    ...
    /// Number of times the function was called.  
    @Atomic public private(set) var coreSdkInitStartCallsCount = 0
    /// `true` if the function was ever called. 
    public var coreSdkInitStartCalled: Bool {
        return coreSdkInitStartCallsCount > 0
    }    
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    ...
    /// Number of times the function was called.  
    @Atomic public private(set) var coreSdkInitSuccessCallsCount = 0
    /// `true` if the function was ever called. 
    public var coreSdkInitSuccessCalled: Bool {
        return coreSdkInitSuccessCallsCount > 0
    }    
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    ...
    public func coreSdkInitSuccess() {
        self.mockCalled = true
        coreSdkInitSuccessCallsCount += 1
    ...
    /// Number of times the function was called.  
    @Atomic public private(set) var moduleInitStartCallsCount = 0
    /// `true` if the function was ever called. 
    public var moduleInitStartCalled: Bool {
        return moduleInitStartCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
    @Atomic public private(set) var moduleInitStartReceivedArguments: (String)?
    /// Arguments from *all* of the times that the function was called. 
    @Atomic public private(set) var moduleInitStartReceivedInvocations: [(String)] = []
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    ...
    public func moduleInitStart(_ moduleName: String) {
        self.mockCalled = true
        moduleInitStartCallsCount += 1
        moduleInitStartReceivedArguments = (moduleName)
        moduleInitStartReceivedInvocations.append((moduleName))
    ...
    /// Number of times the function was called.  
    @Atomic public private(set) var moduleInitSuccessCallsCount = 0
    /// `true` if the function was ever called. 
    public var moduleInitSuccessCalled: Bool {
        return moduleInitSuccessCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
    @Atomic public private(set) var moduleInitSuccessReceivedArguments: (String)?
    /// Arguments from *all* of the times that the function was called. 
    @Atomic public private(set) var moduleInitSuccessReceivedInvocations: [(String)] = []
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    ...
    public func moduleInitSuccess(_ moduleName: String) {
        self.mockCalled = true
        moduleInitSuccessCallsCount += 1
        moduleInitSuccessReceivedArguments = (moduleName)
        moduleInitSuccessReceivedInvocations.append((moduleName))
    ...
    /// Number of times the function was called.  
    @Atomic public private(set) var logHandlingNotificationDeepLinkCallsCount = 0
    /// `true` if the function was ever called. 
    public var logHandlingNotificationDeepLinkCalled: Bool {
        return logHandlingNotificationDeepLinkCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
    @Atomic public private(set) var logHandlingNotificationDeepLinkReceivedArguments: (URL)?
    /// Arguments from *all* of the times that the function was called. 
    @Atomic public private(set) var logHandlingNotificationDeepLinkReceivedInvocations: [(URL)] = []
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    ...
    public func logHandlingNotificationDeepLink(url: URL) {
        self.mockCalled = true
        logHandlingNotificationDeepLinkCallsCount += 1
        logHandlingNotificationDeepLinkReceivedArguments = (url)
        logHandlingNotificationDeepLinkReceivedInvocations.append((url))
    ...
    /// Number of times the function was called.  
    @Atomic public private(set) var logDeepLinkHandledByCallbackCallsCount = 0
    /// `true` if the function was ever called. 
    public var logDeepLinkHandledByCallbackCalled: Bool {
        return logDeepLinkHandledByCallbackCallsCount > 0
    }    
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    ...
    public func logDeepLinkHandledByCallback() {
        self.mockCalled = true
        logDeepLinkHandledByCallbackCallsCount += 1
    ...
    /// Number of times the function was called.  
    @Atomic public private(set) var logDeepLinkHandledByHostAppCallsCount = 0
    /// `true` if the function was ever called. 
    public var logDeepLinkHandledByHostAppCalled: Bool {
        return logDeepLinkHandledByHostAppCallsCount > 0
    }    
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    ...
    public func logDeepLinkHandledByHostApp() {
        self.mockCalled = true
        logDeepLinkHandledByHostAppCallsCount += 1
    ...
    /// Number of times the function was called.  
    @Atomic public private(set) var logDeepLinkHandledExternallyCallsCount = 0
    /// `true` if the function was ever called. 
    public var logDeepLinkHandledExternallyCalled: Bool {
        return logDeepLinkHandledExternallyCallsCount > 0
    }    
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    ...
    public func logDeepLinkHandledExternally() {
        self.mockCalled = true
        logDeepLinkHandledExternallyCallsCount += 1
    ...
    /// Number of times the function was called.  
    @Atomic public private(set) var logDeepLinkWasNotHandledCallsCount = 0
    /// `true` if the function was ever called. 
    public var logDeepLinkWasNotHandledCalled: Bool {
        return logDeepLinkWasNotHandledCallsCount > 0
    }    
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    ...
    public func logDeepLinkWasNotHandled() {
        self.mockCalled = true
        logDeepLinkWasNotHandledCallsCount += 1
...
internal class SimpleTimerMock: SimpleTimer, Mock {
    ...
    /// Number of times the function was called.  
    @Atomic internal private(set) var scheduleAndCancelPreviousCallsCount = 0
    /// `true` if the function was ever called. 
    internal var scheduleAndCancelPreviousCalled: Bool {
        return scheduleAndCancelPreviousCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
    @Atomic internal private(set) var scheduleAndCancelPreviousReceivedArguments: (seconds: Seconds, block: () -> Void)?
    /// Arguments from *all* of the times that the function was called. 
    @Atomic internal private(set) var scheduleAndCancelPreviousReceivedInvocations: [(seconds: Seconds, block: () -> Void)] = []
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    ...
    /// Number of times the function was called.  
    @Atomic internal private(set) var scheduleIfNotAlreadyCallsCount = 0
    /// `true` if the function was ever called. 
    internal var scheduleIfNotAlreadyCalled: Bool {
        return scheduleIfNotAlreadyCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
    @Atomic internal private(set) var scheduleIfNotAlreadyReceivedArguments: (seconds: Seconds, block: () -> Void)?
    /// Arguments from *all* of the times that the function was called. 
    @Atomic internal private(set) var scheduleIfNotAlreadyReceivedInvocations: [(seconds: Seconds, block: () -> Void)] = []
    /// Value to return from the mocked function. 
    ...
    /// Number of times the function was called.  
    @Atomic internal private(set) var cancelCallsCount = 0
    /// `true` if the function was ever called. 
...
public class UserAgentUtilMock: UserAgentUtil, Mock {
    ...
    public var getNSEUserAgentHeaderValueCalled: Bool {
        return getNSEUserAgentHeaderValueCallsCount > 0
    }    
    /// Value to return from the mocked function. 
