...
internal class CommonMocks {
    internal static var shared: CommonMocks = .init()

    internal var mocks: [CommonMock] = []
    private init() {}

    func add(mock: CommonMock) {
        mocks.append(mock)
    }
 ...
 */
public class ActiveWorkspacesManagerMock: ActiveWorkspacesManager, CommonMock {
     ...
     */
    public var underlyingActiveWorkspaces: [SiteId] = []
    /// `true` if the getter or setter of property is called at least once.
    public var activeWorkspacesCalled: Bool {
        activeWorkspacesGetCalled || activeWorkspacesSetCalled
    }

    /// `true` if the getter called on the property at least once.
    public var activeWorkspacesGetCalled: Bool {
        activeWorkspacesGetCallsCount > 0
    }

    public var activeWorkspacesGetCallsCount = 0
    /// `true` if the setter called on the property at least once.
    public var activeWorkspacesSetCalled: Bool {
        activeWorkspacesSetCallsCount > 0
    }

    public var activeWorkspacesSetCallsCount = 0
    ...
    public private(set) var addWorkspaceCallsCount = 0
    /// `true` if the function was ever called.
    public var addWorkspaceCalled: Bool {
        addWorkspaceCallsCount > 0
    }

    /// The arguments from the *last* time the function was called.
    public private(set) var addWorkspaceReceivedArguments: SiteId?
    /// Arguments from *all* of the times that the function was called.
    public private(set) var addWorkspaceReceivedInvocations: [SiteId] = []
    /**
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class DeviceAttributesHookMock: DeviceAttributesHook, CommonMock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class DeviceInfoMock: DeviceInfo, CommonMock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class FileStorageMock: FileStorage, CommonMock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class GlobalDataStoreMock: GlobalDataStore, CommonMock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class HooksManagerMock: HooksManager, CommonMock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class HttpClientMock: HttpClient, CommonMock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class HttpRequestRunnerMock: HttpRequestRunner, CommonMock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
    ...
    /**
     Set closure to get called when function gets called. Great way to test logic or return a value for the function.
     */
    public var requestClosure: ((HttpRequestParams, HttpBaseUrls, URLSession,
    ...
    /**
     Set closure to get called when function gets called. Great way to test logic or return a value for the function.
     */
    public var downloadFileClosure: ((URL, DownloadFileType, URLSession, (URL?) -> Void) -> Void)?
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
internal class HttpRetryPolicyMock: HttpRetryPolicy, CommonMock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class KeyValueStorageMock: KeyValueStorage, CommonMock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class LoggerMock: Logger, CommonMock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class ModuleHookProviderMock: ModuleHookProvider, CommonMock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class ProfileIdentifyHookMock: ProfileIdentifyHook, CommonMock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class ProfileStoreMock: ProfileStore, CommonMock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class QueueMock: Queue, CommonMock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
internal class QueueQueryRunnerMock: QueueQueryRunner, CommonMock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    internal var mockCalled: Bool = false //
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class QueueRequestManagerMock: QueueRequestManager, CommonMock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class QueueRunRequestMock: QueueRunRequest, CommonMock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class QueueRunnerMock: QueueRunner, CommonMock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class QueueRunnerHookMock: QueueRunnerHook, CommonMock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class QueueStorageMock: QueueStorage, CommonMock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class ScreenTrackingHookMock: ScreenTrackingHook, CommonMock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class SdkConfigStoreMock: SdkConfigStore, CommonMock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class SdkCredentialsStoreMock: SdkCredentialsStore, CommonMock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
    ...
    /**
     ...
     When the getter of the property called, the value set here will be returned. Your chance to mock the property.
     */
    public var underlyingCredentials: SdkCredentials!
    /// `true` if the getter or setter of property is called at least once.
    public var credentialsCalled: Bool {
        credentialsGetCalled || credentialsSetCalled
    }

    /// `true` if the getter called on the property at least once.
    public var credentialsGetCalled: Bool {
        credentialsGetCallsCount > 0
    }

    public var credentialsGetCallsCount = 0
    /// `true` if the setter called on the property at least once.
    public var credentialsSetCalled: Bool {
        credentialsSetCallsCount > 0
    }

    public var credentialsSetCallsCount = 0
    /// The mocked property with a getter and setter.
    ...
    /// Number of times the function was called.
    public private(set) var loadCallsCount = 0
    /// `true` if the function was ever called.
    public var loadCalled: Bool {
        loadCallsCount > 0
    }

    /// Value to return from the mocked function.
    public var loadReturnValue: SdkCredentials?
    /**
     Set closure to get called when function gets called. Great way to test logic or return a value for the function.
     The closure has first priority to return a value for the mocked function. If the closure returns `nil`,
     then the mock will attempt to return the value for `loadReturnValue`
     */
    public var loadClosure: (() -> SdkCredentials?)?
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
internal class SimpleTimerMock: SimpleTimer, CommonMock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    internal var mockCalled: Bool = false //
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
internal class SingleScheduleTimerMock: SingleScheduleTimer, CommonMock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    internal var mockCalled: Bool = false //
