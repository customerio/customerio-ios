...
public class HooksManagerMock: HooksManager, Mock {
    ...
    /**
     ...
     When the getter of the property called, the value set here will be returned. Your chance to mock the property. 
     */
    public var underlyingPushNotificationPromptHooks: [PushNotificationPromptHook] = []
    /// `true` if the getter or setter of property is called at least once. 
    public var pushNotificationPromptHooksCalled: Bool {
        pushNotificationPromptHooksGetCalled || pushNotificationPromptHooksSetCalled
    }
    /// `true` if the getter called on the property at least once. 
    public var pushNotificationPromptHooksGetCalled: Bool {
        pushNotificationPromptHooksGetCallsCount > 0
    } 
    public var pushNotificationPromptHooksGetCallsCount = 0
    /// `true` if the setter called on the property at least once. 
    public var pushNotificationPromptHooksSetCalled: Bool {
        pushNotificationPromptHooksSetCallsCount > 0
    } 
    public var pushNotificationPromptHooksSetCallsCount = 0
    /// The mocked property with a getter and setter. 
    public var pushNotificationPromptHooks: [PushNotificationPromptHook] {
        get { 
            self.mockCalled = true
            pushNotificationPromptHooksGetCallsCount += 1
            return underlyingPushNotificationPromptHooks 
        }
        set(value) { 
            self.mockCalled = true
            pushNotificationPromptHooksSetCallsCount += 1
            underlyingPushNotificationPromptHooks = value 
        }
    }    
...
public class ModuleHookProviderMock: ModuleHookProvider, Mock {
    ...
    /**
     ...
     When the getter of the property called, the value set here will be returned. Your chance to mock the property. 
     */
    public var underlyingPushNotificationPromptHook: PushNotificationPromptHook? = nil
    /// `true` if the getter or setter of property is called at least once. 
    public var pushNotificationPromptHookCalled: Bool {
        pushNotificationPromptHookGetCalled || pushNotificationPromptHookSetCalled
    }
    /// `true` if the getter called on the property at least once. 
    public var pushNotificationPromptHookGetCalled: Bool {
        pushNotificationPromptHookGetCallsCount > 0
    } 
    public var pushNotificationPromptHookGetCallsCount = 0
    /// `true` if the setter called on the property at least once. 
    public var pushNotificationPromptHookSetCalled: Bool {
        pushNotificationPromptHookSetCallsCount > 0
    } 
    public var pushNotificationPromptHookSetCallsCount = 0
    /// The mocked property with a getter and setter. 
    public var pushNotificationPromptHook: PushNotificationPromptHook? {
        get { 
            self.mockCalled = true
            pushNotificationPromptHookGetCallsCount += 1
            return underlyingPushNotificationPromptHook 
        }
        set(value) { 
            self.mockCalled = true
            pushNotificationPromptHookSetCallsCount += 1
            underlyingPushNotificationPromptHook = value 
        }
    }    
    ...
    public func resetMock() {
        ...
        screenTrackingHookGetCallsCount = 0
        screenTrackingHookSetCallsCount = 0
        pushNotificationPromptHook = nil 
        pushNotificationPromptHookGetCallsCount = 0
        pushNotificationPromptHookSetCallsCount = 0
    }
...
/**
 Class to easily create a mocked version of the `PushNotificationPromptHook` class. 
 This class is equipped with functions and properties ready for you to mock! 

 Note: This file is automatically generated. This means the mocks should always be up-to-date and has a consistent API.
 See the SDK documentation to learn the basics behind using the mock classes in the SDK. 
 */
public class PushNotificationPromptHookMock: PushNotificationPromptHook, Mock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called. 
    public var mockCalled: Bool = false // 
    ...
    public func resetMock() {
        showPushNotificationPromptCallsCount = 0

        self.mockCalled = false // do last as resetting properties above can make this true
    }

    // MARK: - showPushNotificationPrompt

    /// Number of times the function was called.  
    public private(set) var showPushNotificationPromptCallsCount = 0
    /// `true` if the function was ever called. 
    public var showPushNotificationPromptCalled: Bool {
        return showPushNotificationPromptCallsCount > 0
    }    
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    public var showPushNotificationPromptClosure: (() -> Void)?

    /// Mocked function for `showPushNotificationPrompt()`. Your opportunity to return a mocked value and check result of mock in test code.
    public func showPushNotificationPrompt() {
        self.mockCalled = true
        showPushNotificationPromptCallsCount += 1
        showPushNotificationPromptClosure?()
    }
