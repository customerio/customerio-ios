...
/**
 Class to easily create a mocked version of the `SdkResourceLoader` class.
 This class is equipped with functions and properties ready for you to mock!

 Note: This file is automatically generated. This means the mocks should always be up-to-date and has a consistent API.
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
class SdkResourceLoaderMock: SdkResourceLoader, Mock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    var mockCalled: Bool = false //
    ...
    public func resetMock() {
        loadPlistCallsCount = 0

        mockCalled = false // do last as resetting properties above can make this true
        loadClientInfoJsonCallsCount = 0
    ...
    /// Number of times the function was called.
    @Atomic private(set) var loadPlistCallsCount = 0
    /// `true` if the function was ever called.
    var loadPlistCalled: Bool {
        loadPlistCallsCount > 0
    }

    /// Value to return from the mocked function.
    var loadPlistReturnValue: [String: Any]?
    /**
     Set closure to get called when function gets called. Great way to test logic or return a value for the function.
     The closure has first priority to return a value for the mocked function. If the closure returns `nil`,
     then the mock will attempt to return the value for `loadPlistReturnValue`
     */
    var loadPlistClosure: (() -> [String: Any]?)?

    /// Mocked function for `loadPlist()`. Your opportunity to return a mocked value and check result of mock in test code.
    func loadPlist() -> [String: Any]? {
        mockCalled = true
        loadPlistCallsCount += 1
        return loadPlistClosure.map { $0() } ?? loadPlistReturnValue
    }

    // MARK: - loadClientInfoJson

    /// Number of times the function was called.
    @Atomic private(set) var loadClientInfoJsonCallsCount = 0
    /// `true` if the function was ever called.
    var loadClientInfoJsonCalled: Bool {
        loadClientInfoJsonCallsCount > 0
    }

    /// Value to return from the mocked function.
    var loadClientInfoJsonReturnValue: [String: Any]?
    /**
     Set closure to get called when function gets called. Great way to test logic or return a value for the function.
     The closure has first priority to return a value for the mocked function. If the closure returns `nil`,
     then the mock will attempt to return the value for `loadClientInfoJsonReturnValue`
     */
    var loadClientInfoJsonClosure: (() -> [String: Any]?)?

    /// Mocked function for `loadClientInfoJson()`. Your opportunity to return a mocked value and check result of mock in test code.
    func loadClientInfoJson() -> [String: Any]? {
        mockCalled = true
        loadClientInfoJsonCallsCount += 1
        return loadClientInfoJsonClosure.map { $0() } ?? loadClientInfoJsonReturnValue
    }
}
