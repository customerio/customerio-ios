...
/**
 Class to easily create a mocked version of the `EnvironmentUtil` class.
 This class is equipped with functions and properties ready for you to mock!
...
public class EnvironmentUtilMock: EnvironmentUtil, Mock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    public var mockCalled: Bool = false //
    ...
    /**
     ...
     When the getter of the property called, the value set here will be returned. Your chance to mock the property.
     */
    public var underlyingIsSwiftUIApp: Bool!
    /// `true` if the getter or setter of property is called at least once.
    public var isSwiftUIAppCalled: Bool {
        isSwiftUIAppGetCalled || isSwiftUIAppSetCalled
    }

    /// `true` if the getter called on the property at least once.
    public var isSwiftUIAppGetCalled: Bool {
        isSwiftUIAppGetCallsCount > 0
    }

    public var isSwiftUIAppGetCallsCount = 0
    /// `true` if the setter called on the property at least once.
    public var isSwiftUIAppSetCalled: Bool {
        isSwiftUIAppSetCallsCount > 0
    }

    public var isSwiftUIAppSetCallsCount = 0
    /// The mocked property with a getter and setter.
    public var isSwiftUIApp: Bool {
        get {
            mockCalled = true
            isSwiftUIAppGetCallsCount += 1
            return underlyingIsSwiftUIApp
        }
        set(value) {
            mockCalled = true
            isSwiftUIAppSetCallsCount += 1
            underlyingIsSwiftUIApp = value
        }
    }
...
public class UIKitWrapperMock: UIKitWrapper, Mock {
    ...
    /**
     ...
     When the getter of the property called, the value set here will be returned. Your chance to mock the property.
     */
    public var underlyingUiApplication: UIApplication?
    /// `true` if the getter or setter of property is called at least once.
    public var uiApplicationCalled: Bool {
        uiApplicationGetCalled || uiApplicationSetCalled
    }

    /// `true` if the getter called on the property at least once.
    public var uiApplicationGetCalled: Bool {
        uiApplicationGetCallsCount > 0
    }

    public var uiApplicationGetCallsCount = 0
    /// `true` if the setter called on the property at least once.
    public var uiApplicationSetCalled: Bool {
        uiApplicationSetCallsCount > 0
    }

    public var uiApplicationSetCallsCount = 0
    /// The mocked property with a getter and setter.
    public var uiApplication: UIApplication? {
        get {
            mockCalled = true
            uiApplicationGetCallsCount += 1
            return underlyingUiApplication
        }
        set(value) {
            mockCalled = true
            uiApplicationSetCallsCount += 1
            underlyingUiApplication = value
        }
    }
    #endif
