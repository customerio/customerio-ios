...
extension DIGraphShared {
    ...
    public var sharedEventBusHandler: EventBusHandler {
        ...
        getOrCreateSingleton(forType: EventBusHandler.self) {
    ...
    var sharedSingleScheduleTimer: SingleScheduleTimer {
        // Thread-safe singleton creation using EnhancedSynchronized with concurrent reads and exclusive writes
        getOrCreateSingleton(forType: SingleScheduleTimer.self) {
    ...
    public var sharedDeepLinkUtil: DeepLinkUtil {
        // Thread-safe singleton creation using EnhancedSynchronized with concurrent reads and exclusive writes
        getOrCreateSingleton(forType: DeepLinkUtil.self) {
            _get_deepLinkUtil()
        }
    }
    ...
    var sharedEventBusObserversHolder: EventBusObserversHolder {
        // Thread-safe singleton creation using EnhancedSynchronized with concurrent reads and exclusive writes
        getOrCreateSingleton(forType: EventBusObserversHolder.self) {
    ...
    var sharedEventCache: EventCache {
        // Thread-safe singleton creation using EnhancedSynchronized with concurrent reads and exclusive writes
        getOrCreateSingleton(forType: EventCache.self) {
            _get_eventCache()
        }
    }
    ...
    var sharedEventStorage: EventStorage {
        // Thread-safe singleton creation using EnhancedSynchronized with concurrent reads and exclusive writes
        getOrCreateSingleton(forType: EventStorage.self) {
            _get_eventStorage()
        }
    }
    ...
    public var sharedLockManager: LockManager {
        // Thread-safe singleton creation using EnhancedSynchronized with concurrent reads and exclusive writes
        getOrCreateSingleton(forType: LockManager.self) {
            _get_lockManager()
        }
    }
    ...
    public var sharedLogger: Logger {
        // Thread-safe singleton creation using EnhancedSynchronized with concurrent reads and exclusive writes
        getOrCreateSingleton(forType: Logger.self) {
            _get_logger()
        }
    }
    ...
    var sharedQueueInventoryMemoryStore: QueueInventoryMemoryStore {
        // Thread-safe singleton creation using EnhancedSynchronized with concurrent reads and exclusive writes
        getOrCreateSingleton(forType: QueueInventoryMemoryStore.self) {
    ...
    var sharedEventBus: EventBus {
        // Thread-safe singleton creation using EnhancedSynchronized with concurrent reads and exclusive writes
        getOrCreateSingleton(forType: EventBus.self) {
            _get_eventBus()
        }
    }
