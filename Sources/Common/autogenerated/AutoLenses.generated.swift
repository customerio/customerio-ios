...
extension QueueTask {
  ...
  func storageIdSet(_ storageId: String) -> QueueTask {
    QueueTask(storageId: storageId, type: self.type, data: self.data, runResults: self.runResults)
  }
  func typeSet(_ type: String) -> QueueTask {
    QueueTask(storageId: self.storageId, type: type, data: self.data, runResults: self.runResults)
  }
  func dataSet(_ data: Data) -> QueueTask {
    QueueTask(storageId: self.storageId, type: self.type, data: data, runResults: self.runResults)
  }
  func runResultsSet(_ runResults: QueueTaskRunResults) -> QueueTask {
    QueueTask(storageId: self.storageId, type: self.type, data: self.data, runResults: runResults)
  }
}
extension QueueTaskMetadata {
  ...
  func taskPersistedIdSet(_ taskPersistedId: String) -> QueueTaskMetadata {
    QueueTaskMetadata(taskPersistedId: taskPersistedId, taskType: self.taskType, groupStart: self.groupStart, groupMember: self.groupMember, createdAt: self.createdAt)
  }
  func taskTypeSet(_ taskType: String) -> QueueTaskMetadata {
    QueueTaskMetadata(taskPersistedId: self.taskPersistedId, taskType: taskType, groupStart: self.groupStart, groupMember: self.groupMember, createdAt: self.createdAt)
  }
  func groupStartSet(_ groupStart: String?) -> QueueTaskMetadata {
    QueueTaskMetadata(taskPersistedId: self.taskPersistedId, taskType: self.taskType, groupStart: groupStart, groupMember: self.groupMember, createdAt: self.createdAt)
  }
  func groupMemberSet(_ groupMember: [String]?) -> QueueTaskMetadata {
    QueueTaskMetadata(taskPersistedId: self.taskPersistedId, taskType: self.taskType, groupStart: self.groupStart, groupMember: groupMember, createdAt: self.createdAt)
  }
  func createdAtSet(_ createdAt: Date) -> QueueTaskMetadata {
    QueueTaskMetadata(taskPersistedId: self.taskPersistedId, taskType: self.taskType, groupStart: self.groupStart, groupMember: self.groupMember, createdAt: createdAt)
  }
}
...
extension SdkCredentials {
  ...
  func apiKeySet(_ apiKey: String) -> SdkCredentials {
    SdkCredentials(apiKey: apiKey, region: self.region)
  }
  func regionSet(_ region: Region) -> SdkCredentials {
    SdkCredentials(apiKey: self.apiKey, region: region)
  }
}
