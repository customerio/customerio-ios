...
///   tracker unchanged and interprets a polygon's covering-circle event against membership, plus
///   a throttled `coordinator.refresh` so catalog freshness does not depend on the trigger EXIT
///   alone.
@MainActor
