...
public struct MessagingPushConfigOptions {
    ...
    public enum Factory {
        ...
        public static func create(with dictionary: [String: Any]) -> MessagingPushConfigOptions {
            ...
            let cdpApiKey = dictionary[Keys.cdpApiKey.rawValue] as? String
            ...
            return MessagingPushConfigOptions(
                cdpApiKey: cdpApiKey ?? presetConfig.cdpApiKey,
    ...
    /// internal cdp api key required for NotificationServiceExtension only to track metrics
