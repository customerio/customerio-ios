...
extension DIGraphShared {
    ...
    var sharedPushEventHandlerProxy: PushEventHandlerProxy {
        ...
        getOrCreateSingleton(forType: PushEventHandlerProxy.self) {
    ...
    var sharedPushHistory: PushHistory {
        // Thread-safe singleton creation using EnhancedSynchronized with concurrent reads and exclusive writes
        getOrCreateSingleton(forType: PushHistory.self) {
            _get_pushHistory()
        }
    }
    ...
    var sharedUserNotificationsFrameworkAdapter: UserNotificationsFrameworkAdapter {
        // Thread-safe singleton creation using EnhancedSynchronized with concurrent reads and exclusive writes
        getOrCreateSingleton(forType: UserNotificationsFrameworkAdapter.self) {
