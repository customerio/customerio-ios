...
public class MessagingPushInstanceMock: MessagingPushInstance {
    ...
    public private(set) var registerDeviceTokenReceivedArguments: (deviceToken: Data, onComplete: (Result<Void, CustomerIOError>) -> Void)?
    /// Arguments from *all* of the times that the function was called. 
    public private(set) var registerDeviceTokenReceivedInvocations: [(deviceToken: Data, onComplete: (Result<Void, CustomerIOError>) -> Void)] = []
    /** 
