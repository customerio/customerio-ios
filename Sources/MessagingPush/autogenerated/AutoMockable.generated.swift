...
internal class PushEventHandlerMock: PushEventHandler, Mock {
    ...
    /// Mocked function for `onPushAction(_ pushAction: PushNotificationAction, completionHandler: @Sendable @escaping () -> Void)`. Your opportunity to return a mocked value and check result of mock in test code.
    internal func onPushAction(_ pushAction: PushNotificationAction, completionHandler: @Sendable @escaping () -> Void) {
        self.mockCalled = true
    ...
    /// Mocked function for `shouldDisplayPushAppInForeground(_ push: PushNotification, completionHandler: @Sendable @escaping (Bool) -> Void)`. Your opportunity to return a mocked value and check result of mock in test code.
    internal func shouldDisplayPushAppInForeground(_ push: PushNotification, completionHandler: @Sendable @escaping (Bool) -> Void) {
        self.mockCalled = true
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK. 
 */
internal class PushNotificationLoggerMock: PushNotificationLogger, Mock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called. 
    internal var mockCalled: Bool = false // 
    ...
    public func resetMock() {
        ...
        logReceivedPushMessageReceivedArguments = nil 
        logReceivedPushMessageReceivedInvocations = []
        ...
        logTrackingPushMessageDeliveredReceivedArguments = nil 
        logTrackingPushMessageDeliveredReceivedInvocations = []
        ...
        logTrackingPushMessageOpenedReceivedArguments = nil 
        logTrackingPushMessageOpenedReceivedInvocations = []
    ...
    /// Number of times the function was called.  
    @Atomic internal private(set) var logReceivedPushMessageCallsCount = 0
    /// `true` if the function was ever called. 
    internal var logReceivedPushMessageCalled: Bool {
        return logReceivedPushMessageCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
    @Atomic internal private(set) var logReceivedPushMessageReceivedArguments: (PushNotification)?
    /// Arguments from *all* of the times that the function was called. 
    @Atomic internal private(set) var logReceivedPushMessageReceivedInvocations: [(PushNotification)] = []
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    internal var logReceivedPushMessageClosure: ((PushNotification) -> Void)?
    ...
    internal func logReceivedPushMessage(notification: PushNotification) {
        self.mockCalled = true
        logReceivedPushMessageCallsCount += 1
        logReceivedPushMessageReceivedArguments = (notification)
        logReceivedPushMessageReceivedInvocations.append((notification))
    ...
    /// Number of times the function was called.  
    @Atomic internal private(set) var logReceivedCioPushMessageCallsCount = 0
    /// `true` if the function was ever called. 
    internal var logReceivedCioPushMessageCalled: Bool {
        return logReceivedCioPushMessageCallsCount > 0
    }    
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    internal var logReceivedCioPushMessageClosure: (() -> Void)?
    ...
    internal func logReceivedCioPushMessage() {
        self.mockCalled = true
        logReceivedCioPushMessageCallsCount += 1
    ...
    /// Number of times the function was called.  
    @Atomic internal private(set) var logReceivedNonCioPushMessageCallsCount = 0
    /// `true` if the function was ever called. 
    internal var logReceivedNonCioPushMessageCalled: Bool {
        return logReceivedNonCioPushMessageCallsCount > 0
    }    
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    internal var logReceivedNonCioPushMessageClosure: (() -> Void)?
    ...
    internal func logReceivedNonCioPushMessage() {
        self.mockCalled = true
        logReceivedNonCioPushMessageCallsCount += 1
    ...
    /// Number of times the function was called.  
    @Atomic internal private(set) var logReceivedPushMessageWithEmptyDeliveryIdCallsCount = 0
    /// `true` if the function was ever called. 
    internal var logReceivedPushMessageWithEmptyDeliveryIdCalled: Bool {
        return logReceivedPushMessageWithEmptyDeliveryIdCallsCount > 0
    }    
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    internal var logReceivedPushMessageWithEmptyDeliveryIdClosure: (() -> Void)?
    ...
    internal func logReceivedPushMessageWithEmptyDeliveryId() {
        self.mockCalled = true
        logReceivedPushMessageWithEmptyDeliveryIdCallsCount += 1
    ...
    /// Number of times the function was called.  
    @Atomic internal private(set) var logTrackingPushMessageDeliveredCallsCount = 0
    /// `true` if the function was ever called. 
    internal var logTrackingPushMessageDeliveredCalled: Bool {
        return logTrackingPushMessageDeliveredCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
    @Atomic internal private(set) var logTrackingPushMessageDeliveredReceivedArguments: (String)?
    /// Arguments from *all* of the times that the function was called. 
    @Atomic internal private(set) var logTrackingPushMessageDeliveredReceivedInvocations: [(String)] = []
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    internal var logTrackingPushMessageDeliveredClosure: ((String) -> Void)?
    ...
    internal func logTrackingPushMessageDelivered(deliveryId: String) {
        self.mockCalled = true
        logTrackingPushMessageDeliveredCallsCount += 1
        logTrackingPushMessageDeliveredReceivedArguments = (deliveryId)
        logTrackingPushMessageDeliveredReceivedInvocations.append((deliveryId))
    ...
    /// Number of times the function was called.  
    @Atomic internal private(set) var logPushMetricsAutoTrackingDisabledCallsCount = 0
    /// `true` if the function was ever called. 
    internal var logPushMetricsAutoTrackingDisabledCalled: Bool {
        return logPushMetricsAutoTrackingDisabledCallsCount > 0
    }    
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    internal var logPushMetricsAutoTrackingDisabledClosure: (() -> Void)?
    ...
    internal func logPushMetricsAutoTrackingDisabled() {
        self.mockCalled = true
        logPushMetricsAutoTrackingDisabledCallsCount += 1
    ...
    /// Number of times the function was called.  
    @Atomic internal private(set) var logPushMetricTrackedCallsCount = 0
    /// `true` if the function was ever called. 
    internal var logPushMetricTrackedCalled: Bool {
        return logPushMetricTrackedCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
    @Atomic internal private(set) var logPushMetricTrackedReceivedArguments: (deliveryId: String, event: String)?
    /// Arguments from *all* of the times that the function was called. 
    @Atomic internal private(set) var logPushMetricTrackedReceivedInvocations: [(deliveryId: String, event: String)] = []
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    internal var logPushMetricTrackedClosure: ((String, String) -> Void)?
    ...
    internal func logPushMetricTracked(deliveryId: String, event: String) {
        self.mockCalled = true
    ...
    /// Number of times the function was called.  
    @Atomic internal private(set) var logPushMetricTrackingFailedCallsCount = 0
    /// `true` if the function was ever called. 
    internal var logPushMetricTrackingFailedCalled: Bool {
        return logPushMetricTrackingFailedCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
    @Atomic internal private(set) var logPushMetricTrackingFailedReceivedArguments: (deliveryId: String, event: String, error: Error)?
    /// Arguments from *all* of the times that the function was called. 
    @Atomic internal private(set) var logPushMetricTrackingFailedReceivedInvocations: [(deliveryId: String, event: String, error: Error)] = []
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    internal var logPushMetricTrackingFailedClosure: ((String, String, Error) -> Void)?
    ...
    internal func logPushMetricTrackingFailed(deliveryId: String, event: String, error: Error) {
        self.mockCalled = true
    ...
    /// Number of times the function was called.  
    @Atomic internal private(set) var logClickedPushMessageCallsCount = 0
    /// `true` if the function was ever called. 
    internal var logClickedPushMessageCalled: Bool {
        return logClickedPushMessageCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
    @Atomic internal private(set) var logClickedPushMessageReceivedArguments: (PushNotification)?
    /// Arguments from *all* of the times that the function was called. 
    @Atomic internal private(set) var logClickedPushMessageReceivedInvocations: [(PushNotification)] = []
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    internal var logClickedPushMessageClosure: ((PushNotification) -> Void)?
    ...
    internal func logClickedPushMessage(notification: PushNotification) {
        self.mockCalled = true
        logClickedPushMessageCallsCount += 1
        logClickedPushMessageReceivedArguments = (notification)
        logClickedPushMessageReceivedInvocations.append((notification))
    ...
    /// Number of times the function was called.  
    @Atomic internal private(set) var logClickedCioPushMessageCallsCount = 0
    /// `true` if the function was ever called. 
    internal var logClickedCioPushMessageCalled: Bool {
        return logClickedCioPushMessageCallsCount > 0
    }    
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    internal var logClickedCioPushMessageClosure: (() -> Void)?
    ...
    internal func logClickedCioPushMessage() {
        self.mockCalled = true
        logClickedCioPushMessageCallsCount += 1
    ...
    /// Number of times the function was called.  
    @Atomic internal private(set) var logClickedNonCioPushMessageCallsCount = 0
    /// `true` if the function was ever called. 
    internal var logClickedNonCioPushMessageCalled: Bool {
        return logClickedNonCioPushMessageCallsCount > 0
    }    
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    internal var logClickedNonCioPushMessageClosure: (() -> Void)?
    ...
    internal func logClickedNonCioPushMessage() {
        self.mockCalled = true
        logClickedNonCioPushMessageCallsCount += 1
    ...
    /// Number of times the function was called.  
    @Atomic internal private(set) var logClickedPushMessageWithEmptyDeliveryIdCallsCount = 0
    /// `true` if the function was ever called. 
    internal var logClickedPushMessageWithEmptyDeliveryIdCalled: Bool {
        return logClickedPushMessageWithEmptyDeliveryIdCallsCount > 0
    }    
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    internal var logClickedPushMessageWithEmptyDeliveryIdClosure: (() -> Void)?
    ...
    internal func logClickedPushMessageWithEmptyDeliveryId() {
        self.mockCalled = true
        logClickedPushMessageWithEmptyDeliveryIdCallsCount += 1
    ...
    /// Number of times the function was called.  
    @Atomic internal private(set) var logTrackingPushMessageOpenedCallsCount = 0
    /// `true` if the function was ever called. 
    internal var logTrackingPushMessageOpenedCalled: Bool {
        return logTrackingPushMessageOpenedCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
    @Atomic internal private(set) var logTrackingPushMessageOpenedReceivedArguments: (String)?
    /// Arguments from *all* of the times that the function was called. 
    @Atomic internal private(set) var logTrackingPushMessageOpenedReceivedInvocations: [(String)] = []
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    internal var logTrackingPushMessageOpenedClosure: ((String) -> Void)?
    ...
    internal func logTrackingPushMessageOpened(deliveryId: String) {
        self.mockCalled = true
        logTrackingPushMessageOpenedCallsCount += 1
...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK. 
 */
internal class RichPushDeliveryTrackerMock: RichPushDeliveryTracker, Mock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called. 
    internal var mockCalled: Bool = false // 
    ...
    /// Number of times the function was called.  
    @Atomic internal private(set) var trackMetricCallsCount = 0
    /// `true` if the function was ever called. 
    internal var trackMetricCalled: Bool {
        return trackMetricCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
    @Atomic internal private(set) var trackMetricReceivedArguments: (token: String, event: Metric, deliveryId: String, timestamp: String?)?
    /// Arguments from *all* of the times that the function was called. 
    @Atomic internal private(set) var trackMetricReceivedInvocations: [(token: String, event: Metric, deliveryId: String, timestamp: String?)] = []
    /// Value to return from the mocked function. 
    internal var trackMetricReturnValue: Result<Void, HttpRequestError>!
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     The closure has first priority to return a value for the mocked function. If the closure returns `nil`, 
     then the mock will attempt to return the value for `trackMetricReturnValue`
     */
    internal var trackMetricClosure: ((String, Metric, String, String?) -> Result<Void, HttpRequestError>)?

    /// Mocked function for `trackMetric(token: String, event: Metric, deliveryId: String, timestamp: String?)`. Your opportunity to return a mocked value and check result of mock in test code.
    internal func trackMetric(token: String, event: Metric, deliveryId: String, timestamp: String?) -> Result<Void, HttpRequestError> {
        self.mockCalled = true
        trackMetricCallsCount += 1
        trackMetricReceivedArguments = (token: token, event: event, deliveryId: deliveryId, timestamp: timestamp)
        trackMetricReceivedInvocations.append((token: token, event: event, deliveryId: deliveryId, timestamp: timestamp))
        return trackMetricClosure.map({ $0(token, event, deliveryId, timestamp) }) ?? trackMetricReturnValue
    }
