...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
class PushNotificationLoggerMock: PushNotificationLogger, Mock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
    var mockCalled: Bool = false //
    ...
    /// Number of times the function was called.
    @Atomic private(set) var logReceivedPushMessageCallsCount = 0
    /// `true` if the function was ever called.
    ...
    /// The arguments from the *last* time the function was called.
    @Atomic private(set) var logReceivedPushMessageReceivedArguments: PushNotification?
    /// Arguments from *all* of the times that the function was called.
    @Atomic private(set) var logReceivedPushMessageReceivedInvocations: [PushNotification] = []
    /**
     Set closure to get called when function gets called. Great way to test logic or return a value for the function.
     */
    ...
    /// Number of times the function was called.
    @Atomic private(set) var logReceivedCioPushMessageCallsCount = 0
    /// `true` if the function was ever called.
    ...
    /// Number of times the function was called.
    @Atomic private(set) var logReceivedNonCioPushMessageCallsCount = 0
    /// `true` if the function was ever called.
    ...
    /// Number of times the function was called.
    @Atomic private(set) var logReceivedPushMessageWithEmptyDeliveryIdCallsCount = 0
    /// `true` if the function was ever called.
    ...
    /// Number of times the function was called.
    @Atomic private(set) var logTrackingPushMessageDeliveredCallsCount = 0
    /// `true` if the function was ever called.
    ...
    /// The arguments from the *last* time the function was called.
    @Atomic private(set) var logTrackingPushMessageDeliveredReceivedArguments: String?
    /// Arguments from *all* of the times that the function was called.
    @Atomic private(set) var logTrackingPushMessageDeliveredReceivedInvocations: [String] = []
    /**
     Set closure to get called when function gets called. Great way to test logic or return a value for the function.
     */
    ...
    /// Number of times the function was called.
    @Atomic private(set) var logPushMetricsAutoTrackingDisabledCallsCount = 0
    /// `true` if the function was ever called.
    ...
    /// Number of times the function was called.
    @Atomic private(set) var logClickedPushMessageCallsCount = 0
    /// `true` if the function was ever called.
    ...
    /// The arguments from the *last* time the function was called.
    @Atomic private(set) var logClickedPushMessageReceivedArguments: PushNotification?
    /// Arguments from *all* of the times that the function was called.
    @Atomic private(set) var logClickedPushMessageReceivedInvocations: [PushNotification] = []
    /**
     Set closure to get called when function gets called. Great way to test logic or return a value for the function.
     */
    ...
    /// Number of times the function was called.
    @Atomic private(set) var logClickedCioPushMessageCallsCount = 0
    /// `true` if the function was ever called.
    ...
    /// Number of times the function was called.
    @Atomic private(set) var logClickedNonCioPushMessageCallsCount = 0
    /// `true` if the function was ever called.
    ...
    /// Number of times the function was called.
    @Atomic private(set) var logClickedPushMessageWithEmptyDeliveryIdCallsCount = 0
    /// `true` if the function was ever called.
    ...
    /// Number of times the function was called.
    @Atomic private(set) var logTrackingPushMessageOpenedCallsCount = 0
    /// `true` if the function was ever called.
    ...
    /// The arguments from the *last* time the function was called.
    @Atomic private(set) var logTrackingPushMessageOpenedReceivedArguments: String?
    /// Arguments from *all* of the times that the function was called.
    @Atomic private(set) var logTrackingPushMessageOpenedReceivedInvocations: [String] = []
    /**
     Set closure to get called when function gets called. Great way to test logic or return a value for the function.
     */
...
class RichPushDeliveryTrackerMock: RichPushDeliveryTracker, Mock {
    ...
    /// The arguments from the *last* time the function was called.
    @Atomic private(set) var trackMetricReceivedArguments: (token: String, event: Metric, deliveryId: String, timestamp: String?)?
    /// Arguments from *all* of the times that the function was called.
    @Atomic private(set) var trackMetricReceivedInvocations: [(token: String, event: Metric, deliveryId: String, timestamp: String?)] = []
    /// Value to return from the mocked function.
    var trackMetricReturnValue: Result<Void, HttpRequestError>!
    /**
     Set closure to get called when function gets called. Great way to test logic or return a value for the function.
     The closure has first priority to return a value for the mocked function. If the closure returns `nil`,
     then the mock will attempt to return the value for `trackMetricReturnValue`
     */
    var trackMetricClosure: ((String, Metric, String, String?) -> Result<Void, HttpRequestError>)?
    ...
    func trackMetric(token: String, event: Metric, deliveryId: String, timestamp: String?) -> Result<Void, HttpRequestError> {
        mockCalled = true
        trackMetricCallsCount += 1
