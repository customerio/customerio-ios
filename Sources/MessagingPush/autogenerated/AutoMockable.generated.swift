...
/**
 ...
 See the SDK documentation to learn the basics behind using the mock classes in the SDK. 
 */
internal class DeepLinkUtilMock: DeepLinkUtil, Mock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called. 
    internal var mockCalled: Bool = false // 
...
internal class PushClickHandlerMock: PushClickHandler, Mock {
    ...
    /// Number of times the function was called.  
    internal private(set) var cleanupAfterPushInteractedWithCallsCount = 0
    /// `true` if the function was ever called. 
    internal var cleanupAfterPushInteractedWithCalled: Bool {
        return cleanupAfterPushInteractedWithCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
    internal private(set) var cleanupAfterPushInteractedWithReceivedArguments: (PushNotification)?
    /// Arguments from *all* of the times that the function was called. 
    internal private(set) var cleanupAfterPushInteractedWithReceivedInvocations: [(PushNotification)] = []
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    ...
    /// Number of times the function was called.  
    internal private(set) var trackPushMetricsCallsCount = 0
    /// `true` if the function was ever called. 
    internal var trackPushMetricsCalled: Bool {
        return trackPushMetricsCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
    internal private(set) var trackPushMetricsReceivedArguments: (PushNotification)?
    /// Arguments from *all* of the times that the function was called. 
    internal private(set) var trackPushMetricsReceivedInvocations: [(PushNotification)] = []
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    ...
    /// The arguments from the *last* time the function was called. 
    internal private(set) var handleDeepLinkReceivedArguments: (PushNotification)?
    /// Arguments from *all* of the times that the function was called. 
    internal private(set) var handleDeepLinkReceivedInvocations: [(PushNotification)] = []
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
...
internal class PushEventHandlerMock: PushEventHandler, Mock {
    ...
    /// Number of times the function was called.  
    internal private(set) var onPushActionCallsCount = 0
    /// `true` if the function was ever called. 
    internal var onPushActionCalled: Bool {
        return onPushActionCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
    internal private(set) var onPushActionReceivedArguments: (pushAction: PushNotificationAction, completionHandler: () -> Void)?
    /// Arguments from *all* of the times that the function was called. 
    internal private(set) var onPushActionReceivedInvocations: [(pushAction: PushNotificationAction, completionHandler: () -> Void)] = []
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    ...
    /// Number of times the function was called.  
    internal private(set) var shouldDisplayPushAppInForegroundCallsCount = 0
    /// `true` if the function was ever called. 
    internal var shouldDisplayPushAppInForegroundCalled: Bool {
        return shouldDisplayPushAppInForegroundCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
    internal private(set) var shouldDisplayPushAppInForegroundReceivedArguments: (push: PushNotification, completionHandler: (UNNotificationPresentationOptions) -> Void)?
    /// Arguments from *all* of the times that the function was called. 
    internal private(set) var shouldDisplayPushAppInForegroundReceivedInvocations: [(push: PushNotification, completionHandler: (UNNotificationPresentationOptions) -> Void)] = []
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    internal var shouldDisplayPushAppInForegroundClosure: ((PushNotification, @escaping (UNNotificationPresentationOptions) -> Void) -> Void)?
    ...
    internal func shouldDisplayPushAppInForeground(_ push: PushNotification, completionHandler: @escaping (UNNotificationPresentationOptions) -> Void) {
        self.mockCalled = true
...
internal class PushEventHandlerProxyMock: PushEventHandlerProxy, Mock {
    ...
    /// Number of times the function was called.  
    internal private(set) var addPushEventHandlerCallsCount = 0
    /// `true` if the function was ever called. 
    internal var addPushEventHandlerCalled: Bool {
        return addPushEventHandlerCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
    internal private(set) var addPushEventHandlerReceivedArguments: (PushEventHandler)?
    /// Arguments from *all* of the times that the function was called. 
    internal private(set) var addPushEventHandlerReceivedInvocations: [(PushEventHandler)] = []
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
...
internal class PushHistoryMock: PushHistory, Mock {
    ...
    /// Number of times the function was called.  
    internal private(set) var hasHandledPushCallsCount = 0
    /// `true` if the function was ever called. 
    internal var hasHandledPushCalled: Bool {
        return hasHandledPushCallsCount > 0
    }    
    /// The arguments from the *last* time the function was called. 
    internal private(set) var hasHandledPushReceivedArguments: (pushEvent: PushHistoryEvent, pushId: String, pushDeliveryDate: Date)?
    /// Arguments from *all* of the times that the function was called. 
    internal private(set) var hasHandledPushReceivedInvocations: [(pushEvent: PushHistoryEvent, pushId: String, pushDeliveryDate: Date)] = []
    /// Value to return from the mocked function. 
