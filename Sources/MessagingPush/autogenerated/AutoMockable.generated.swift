...
/**
 Class to easily create a mocked version of the `PushNotificationCenterRegistrar` class. 
 This class is equipped with functions and properties ready for you to mock! 
 ...
 */
@available(iOSApplicationExtension, unavailable)
internal class PushNotificationCenterRegistrarMock: PushNotificationCenterRegistrar, Mock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called. 
    internal var mockCalled: Bool = false // 
    ...
    /// Number of times the function was called.  
    @Atomic internal private(set) var activateCallsCount = 0
    /// `true` if the function was ever called. 
    internal var activateCalled: Bool {
        return activateCallsCount > 0
    }    
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    internal var activateClosure: (() -> Void)?

    /// Mocked function for `activate()`. Your opportunity to return a mocked value and check result of mock in test code.
...
internal class RichPushDeliveryTrackerMock: RichPushDeliveryTracker, Mock {
    ...
    /// The arguments from the *last* time the function was called. 
    @Atomic internal private(set) var trackMetricReceivedArguments: (token: String, event: Metric, deliveryId: String, timestamp: String?, onComplete: (Result<Void, HttpRequestError>) -> Void)?
    /// Arguments from *all* of the times that the function was called. 
    @Atomic internal private(set) var trackMetricReceivedInvocations: [(token: String, event: Metric, deliveryId: String, timestamp: String?, onComplete: (Result<Void, HttpRequestError>) -> Void)] = []
    /** 
     Set closure to get called when function gets called. Great way to test logic or return a value for the function. 
     */
    internal var trackMetricClosure: ((String, Metric, String, String?, @escaping (Result<Void, HttpRequestError>) -> Void) -> Void)?
    ...
    internal func trackMetric(token: String, event: Metric, deliveryId: String, timestamp: String?, onComplete: @escaping (Result<Void, HttpRequestError>) -> Void) {
        self.mockCalled = true
        trackMetricCallsCount += 1
