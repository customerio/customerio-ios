...
/**
 Class to easily create a mocked version of the `FCMAutoFetchDeviceToken` class.
 This class is equipped with functions and properties ready for you to mock!

 Note: This file is automatically generated. This means the mocks should always be up-to-date and has a consistent API.
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
class FCMAutoFetchDeviceTokenMock: FCMAutoFetchDeviceToken, Mock {
...
/**
 Class to easily create a mocked version of the `FirebaseMessagingIntegration` class.
 This class is equipped with functions and properties ready for you to mock!

 Note: This file is automatically generated. This means the mocks should always be up-to-date and has a consistent API.
 See the SDK documentation to learn the basics behind using the mock classes in the SDK.
 */
public class FirebaseMessagingIntegrationMock: FirebaseMessagingIntegration, Mock {
    /// If *any* interactions done on mock. `true` if any method or property getter/setter called.
     ...
     */
    public var underlyingDelegate: MessagingDelegate? = nil
    ...
    public var delegate: MessagingDelegate? {
        get {
            mockCalled = true
    ...
    /**
     ...
     When the getter of the property called, the value set here will be returned. Your chance to mock the property.
     */
    public var underlyingApnsToken: Data? = nil
    /// `true` if the getter or setter of property is called at least once.
    public var apnsTokenCalled: Bool {
        apnsTokenGetCalled || apnsTokenSetCalled
    }

    /// `true` if the getter called on the property at least once.
    public var apnsTokenGetCalled: Bool {
        apnsTokenGetCallsCount > 0
    }

    public var apnsTokenGetCallsCount = 0
    /// `true` if the setter called on the property at least once.
    public var apnsTokenSetCalled: Bool {
        apnsTokenSetCallsCount > 0
    }

    public var apnsTokenSetCallsCount = 0
    /// The mocked property with a getter and setter.
    public var apnsToken: Data? {
        get {
            mockCalled = true
            apnsTokenGetCallsCount += 1
            return underlyingApnsToken
        }
        set(value) {
            mockCalled = true
            apnsTokenSetCallsCount += 1
            underlyingApnsToken = value
        }
    }
