...
public class MessagingPushFCMInstanceMock: MessagingPushFCMInstance {
    ...
    public private(set) var didReceiveRegistrationTokenReceivedArguments: (messaging: Any, fcmToken: String?, onComplete: (Result<Void, CustomerIOError>) -> Void)?
    /// Arguments from *all* of the times that the function was called. 
    public private(set) var didReceiveRegistrationTokenReceivedInvocations: [(messaging: Any, fcmToken: String?, onComplete: (Result<Void, CustomerIOError>) -> Void)] = []
    /** 
    ...
    public func messaging(_ messaging: Any, didReceiveRegistrationToken fcmToken: String?, onComplete: @escaping (Result<Void, CustomerIOError>) -> Void) {
        self.mockCalled = true
        didReceiveRegistrationTokenCallsCount += 1
        didReceiveRegistrationTokenReceivedArguments = (messaging: messaging, fcmToken: fcmToken, onComplete: onComplete)
        didReceiveRegistrationTokenReceivedInvocations.append((messaging: messaging, fcmToken: fcmToken, onComplete: onComplete))
