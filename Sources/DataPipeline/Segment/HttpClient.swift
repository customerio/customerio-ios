...
public class HTTPClient {
    ...
    init() {
        // TODO: set config options based on module config
        ...
        self.session = Self.configuredSession(for: apiKey)
    }
...
extension HTTPClient {
    ...
    static func getDefaultAPIHost() -> String {
        defaultAPIHost
    }

    static func getDefaultCDNHost() -> String {
        defaultCDNHost
    }

    func configuredRequest(for url: URL, method: String) -> URLRequest {
    ...
    static func configuredSession(for writeKey: String) -> URLSession {
