 ...
 */
class DataPipelinesLoggerMock: DataPipelinesLogger, Mock {
    ...
    @Atomic private(set) var logStoringDevicePushTokenCallsCount = 0
    ...
    @Atomic private(set) var logStoringDevicePushTokenReceivedArguments: (token: String, userId: String?)?
    /// Arguments from *all* of the times that the function was called.
    @Atomic private(set) var logStoringDevicePushTokenReceivedInvocations: [(token: String, userId: String?)] = []
    /**
    ...
    /// Number of times the function was called.
    @Atomic private(set) var logStoringBlankPushTokenCallsCount = 0
    /// `true` if the function was ever called.
    ...
    /// Number of times the function was called.
    @Atomic private(set) var logRegisteringPushTokenCallsCount = 0
    /// `true` if the function was ever called.
    ...
    /// The arguments from the *last* time the function was called.
    @Atomic private(set) var logRegisteringPushTokenReceivedArguments: (token: String, userId: String?)?
    /// Arguments from *all* of the times that the function was called.
    @Atomic private(set) var logRegisteringPushTokenReceivedInvocations: [(token: String, userId: String?)] = []
    /**
     Set closure to get called when function gets called. Great way to test logic or return a value for the function.
     */
    ...
    /// Number of times the function was called.
    @Atomic private(set) var logPushTokenRefreshedCallsCount = 0
    /// `true` if the function was ever called.
