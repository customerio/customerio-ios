...
// MARK: - LocationServices (public protocol)
...
/// to get the instance. Before initialization, the same accessor returns an implementation
/// that logs an error when methods are used.
///
/// **Example:**
/// ```swift
...
// MARK: - UninitializedLocationServices (internal, pre-initialization)
