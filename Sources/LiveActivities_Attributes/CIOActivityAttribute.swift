...
/// the Customer.io SDK. The `cioInstanceId` you supply is used as the
...
/// and is unknown to the server), `cioInstanceId` is chosen by the app
...
///     var cioInstanceId: String   // e.g. the order number
